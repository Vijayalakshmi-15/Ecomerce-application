...
const { adduser, login, resetpwd,islogin,isadmin } = require("../controler/usercont")
const { upload, add, getprod, upddct, deldct, updprod, updpimg, addrv } = require("../controler/prodcont")
const { addcart, incqty, decqty, delcart, getcart } = require("../controler/cartcont")
